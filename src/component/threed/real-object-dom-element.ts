...
export default class RealObjectDomElement extends RealObjectMesh {
  ...
  buildCSS3DObject() {
    ...
    var { dimension } = this.component.state;
  ...
  updateTranslate() {
    ...
    var { x = 1, y = 1, z = 1 } = this.component.state.translate;
  ...
  updateRotate() {
    ...
    var { x = 1, y = 1, z = 1 } = this.component.state.rotate;
  ...
  updateDimension() {
    ...
    var dimension = this.component.state.dimension;
    this.component.domElement.style.width = dimension.width + "px";
    this.component.domElement.style.height = dimension.height + "px";
  }

  /* TODO hidden이 동작하지 않는다. 방법을 찾아라. */
  updateHidden() {
    super.updateHidden();
  }
