...
export class ModelAndState extends EventSource
  implements ComponentModel, EventCallback {
  /**
  ...
  setState(props: Object | string, value?: any) {
    if (typeof props === "string") return this.setState({ [props]: value });
...
[
  ...
  Object.defineProperty(ModelAndState.prototype, property, {
    get() {
