...
import { warn, error, clonedeep } from "../util/index";
import compile from "../real/compile";
...
export default class RootContainer extends Container {
  ...
  private removeTemplate(prefix: string, component: Component) {
    ...
    else delete this._templateMap[prefix];
  ...
  private addTraverse(component: Component) {
    ...
    var { id, templatePrefix } = component.model;
