  ...
  function renderObject(object, camera, cameraCSSMatrix) {
    if (object instanceof CSS3DObject) {
      ...
      if (object instanceof CSS3DSprite) {
        ...
        matrix.transpose();
        matrix.copyPosition((object as any) /* CSS3DSprite */.matrixWorld);
        matrix.scale((object as any) /* CSS3DSprite */.scale);
      ...
      if (cachedStyle === undefined || cachedStyle !== style) {
        ...
        if (isIE) {
          (objectData as any).distanceToCameraSquared = getDistanceToSquared(
            camera,
            object
          );
        }
