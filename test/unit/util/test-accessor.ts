...
describe('accessor', function () {
  ...
  describe('invalid accessor', function () {
    it('공백 속성인 경우에는 오브젝트 자신이 반환되어야 한다.', function () {
  ...
  describe('deeper level attribute', function () {
    it('다 단계의 속성 값을 가져올 수 있어야 한다.', function () {
      var accessor = buildAccessor('attr-a.attr-ab');

      expect(accessor(o)).to.equal('ab');
    });

    it('배열 인덱스가 포함된 다단계 속성 값을 가져올 수 있어야 한다.', function () {
